...
public partial class _036 : ContentPage
{
    ...
    const string paperTitle = "The Life Carriers";
    const string paperAuthor = "Vorondadek Son";

	public _036(XamlPaperViewModel vm)
	{
		InitializeComponent();
		BindingContext = vm;
		vm.contentPage = this;
