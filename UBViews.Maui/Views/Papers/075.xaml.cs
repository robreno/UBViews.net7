...
public partial class _075 : ContentPage
{
    ...
    const string paperTitle = "The Default of Adam and Eve";
    const string paperAuthor = "Solonia";

	public _075(XamlPaperViewModel vm)
	{
		InitializeComponent();
		BindingContext = vm;
		vm.contentPage = this;
