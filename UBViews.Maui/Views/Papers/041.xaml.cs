...
public partial class _041 : ContentPage
{
    ...
    const string paperTitle = "Physical Aspects of the Local Universe";
    const string paperAuthor = "Archangel";

	public _041(XamlPaperViewModel vm)
	{
		InitializeComponent();
		BindingContext = vm;
		vm.contentPage = this;
