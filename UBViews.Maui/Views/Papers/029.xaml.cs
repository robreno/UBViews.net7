...
public partial class _029 : ContentPage
{
    ...
    const string paperTitle = "The Universe Power Directors";
    const string paperAuthor = "Universal Censor";

	public _029(XamlPaperViewModel vm)
	{
		InitializeComponent();
		BindingContext = vm;
		vm.contentPage = this;
