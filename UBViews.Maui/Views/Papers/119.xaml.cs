...
public partial class _119 : ContentPage
{
    ...
    const string paperTitle = "The Bestowals of Christ Michael";
    const string paperAuthor = "Chief of Evening Stars";

	public _119(XamlPaperViewModel vm)
	{
		InitializeComponent();
		BindingContext = vm;
		vm.contentPage = this;
