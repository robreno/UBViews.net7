...
public partial class _038 : ContentPage
{
    ...
    const string paperTitle = "Ministering Spirits of the Local Universe";
    const string paperAuthor = "Melchizedek";

	public _038(XamlPaperViewModel vm)
	{
		InitializeComponent();
		BindingContext = vm;
		vm.contentPage = this;
