...
public partial class _028 : ContentPage
{
    ...
    const string paperTitle = "Ministering Spirits of the Superuniverses";
    const string paperAuthor = "Mighty Messenger";

	public _028(XamlPaperViewModel vm)
	{
		InitializeComponent();
		BindingContext = vm;
		vm.contentPage = this;
