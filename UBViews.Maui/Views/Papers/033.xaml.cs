...
public partial class _033 : ContentPage
{
    ...
    const string paperTitle = "Administration of the Local Universe";
    const string paperAuthor = "Chief of Archangels";

	public _033(XamlPaperViewModel vm)
	{
		InitializeComponent();
		BindingContext = vm;
		vm.contentPage = this;
