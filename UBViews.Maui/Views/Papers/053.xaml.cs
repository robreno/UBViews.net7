...
public partial class _053 : ContentPage
{
    ...
    const string paperTitle = "The Lucifer Rebellion";
    const string paperAuthor = "Manovandet Melchizedek";

	public _053(XamlPaperViewModel vm)
	{
		InitializeComponent();
		BindingContext = vm;
		vm.contentPage = this;
