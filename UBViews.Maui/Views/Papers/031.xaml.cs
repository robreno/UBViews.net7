...
public partial class _031 : ContentPage
{
    const string loadOnlineMp3 = "Load Online MP3";
	const string loadHls = "Load HTTP Live Stream (HLS)";
	const string loadLocalResource = "Load Local Resource";
	const string resetSource = "Reset Source to null";
    const string partTitle = "The Central and Superuniverses";
    const string paperTitle = "The Corps of the Finality";
    const string paperAuthor = "Divine Counselor and One Without Name and Number";

	public _031(XamlPaperViewModel vm)
	{
		InitializeComponent();
		BindingContext = vm;
		vm.contentPage = this;
