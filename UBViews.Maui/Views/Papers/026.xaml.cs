...
public partial class _026 : ContentPage
{
    ...
    const string paperTitle = "Ministering Spirits of the Central Universe";
    const string paperAuthor = "Perfector of Wisdom";

	public _026(XamlPaperViewModel vm)
	{
		InitializeComponent();
		BindingContext = vm;
		vm.contentPage = this;
