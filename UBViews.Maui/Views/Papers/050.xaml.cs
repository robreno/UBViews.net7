...
public partial class _050 : ContentPage
{
    ...
    const string paperTitle = "The Planetary Princes";
    const string paperAuthor = "Secondary Lanonandek";

	public _050(XamlPaperViewModel vm)
	{
		InitializeComponent();
		BindingContext = vm;
		vm.contentPage = this;
