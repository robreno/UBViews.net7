...
public partial class _110 : ContentPage
{
    ...
    const string paperTitle = "Relation of Adjusters to Individual Mortals";
    const string paperAuthor = "Solitary Messenger";

	public _110(XamlPaperViewModel vm)
	{
		InitializeComponent();
		BindingContext = vm;
		vm.contentPage = this;
