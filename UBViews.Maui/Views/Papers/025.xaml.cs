...
public partial class _025 : ContentPage
{
    ...
    const string paperTitle = "The Messenger Hosts of Space";
    const string paperAuthor = "One High in Authority";

	public _025(XamlPaperViewModel vm)
	{
		InitializeComponent();
		BindingContext = vm;
		vm.contentPage = this;
