...
public partial class _037 : ContentPage
{
    const string loadOnlineMp3 = "Load Online MP3";
	const string loadHls = "Load HTTP Live Stream (HLS)";
	const string loadLocalResource = "Load Local Resource";
	const string resetSource = "Reset Source to null";
    const string partTitle = "The Evolution of Local Universes";
    const string paperTitle = "Personalities of the Local Universe";
    const string paperAuthor = "Brilliant Evening Star";

	public _037(XamlPaperViewModel vm)
	{
		InitializeComponent();
		BindingContext = vm;
		vm.contentPage = this;
