...
public partial class _120 : ContentPage
{
    ...
    const string paperTitle = "The Bestowal of Michael on Urantia";
    const string paperAuthor = "Mantutia Melchizedek";

	public _120(XamlPaperViewModel vm)
	{
		InitializeComponent();
		BindingContext = vm;
		vm.contentPage = this;
