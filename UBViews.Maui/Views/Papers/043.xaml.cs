...
public partial class _043 : ContentPage
{
    ...
    const string paperTitle = "The Constellations";
    const string paperAuthor = "Malavatia Melchizedek";

	public _043(XamlPaperViewModel vm)
	{
		InitializeComponent();
		BindingContext = vm;
		vm.contentPage = this;
