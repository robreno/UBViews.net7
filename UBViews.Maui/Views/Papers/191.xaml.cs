...
public partial class _191 : ContentPage
{
    const string loadOnlineMp3 = "Load Online MP3";
	const string loadHls = "Load HTTP Live Stream (HLS)";
	const string loadLocalResource = "Load Local Resource";
	const string resetSource = "Reset Source to null";
    const string partTitle = "The Life and Teachings of Jesus";
    const string paperTitle = "Appearances to the Apostles and Other Leaders";
    const string paperAuthor = "Midwayer Commission";

	public _191(XamlPaperViewModel vm)
	{
		InitializeComponent();
		BindingContext = vm;
		vm.contentPage = this;
