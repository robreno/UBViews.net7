...
public partial class _113 : ContentPage
{
    ...
    const string paperTitle = "Seraphic Guardians of Destiny";
    const string paperAuthor = "Chief of Seraphim";

	public _113(XamlPaperViewModel vm)
	{
		InitializeComponent();
		BindingContext = vm;
		vm.contentPage = this;
